...
#' \describe{
#' \item{gebco_23}{The GEBCO grid, 2023 version "ice surface"}
...
#' \item{kerguelen}{Kerguelen Plateau Bathymetric Grid,  \url{https://doi.org/10.26186/147703}}
...
readtopo <- function(topo = c("gebco_23", "gebco_08", "ibcso",
                              "etopo1", "etopo2",
                              "kerguelen",
