...
distance_to_ice_edge <- function(date, threshold = 15,  xylim = NULL,
  ...
  distance_to_ice_edge0(date, threshold = threshold, xylim = xylim, returnfiles = FALSE, 
                        inputfiles = inputfiles, hemisphere = hemisphere, latest = latest)
}

distance_to_ice_edge0 <- function(date, threshold = 15,  xylim = NULL,
                                  hemisphere = "south", returnfiles = FALSE, inputfiles = NULL, latest = NULL) {
  ice <- readice(date, hemisphere = hemisphere, inputfiles = inputfiles, setNA = FALSE, latest = latest, xylim = xylim)
