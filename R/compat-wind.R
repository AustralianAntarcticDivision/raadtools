# R/compat-wind.R
# Front door for readwind() - dispatches to the terra-native reader

#' Read wind data
#'
#' @description
#' \code{readwind} picks a sensible default and returns a terra
#' \code{SpatRaster}. For the historical defaults pinned explicitly, see
#' \code{\link{read_ncep2_wind_6hourly}}.
#'
...
readwind <- function(date,
  ...
  .shim_notice("readwind", "read_ncep2_wind_6hourly")
