...
The package uses the R [terra package](https://CRAN.R-project.org/package=terra) and always provides data as a `SpatRaster`. Each data set is individually handled by a function to ensure the spatial and temporal registration is correct. 
